...
public class GetListByActiveTeamAndEmployeesQuery : IRequestHandler<GetListByActiveTeamAndEmployeesRequest, GetListResponse<GetListTeamAndEmployeeListItemDto>>
{
    ...
    public GetListByActiveTeamAndEmployeesQuery(ITeamAndEmployeeService teamAndEmployeeService, IMapper mapper, ITeamService teamService, IEmployeeService employeeService, TeamAndEmployeesBusinessRules teamAndEmployeesBusinessRules)
    {
    ...
    public async Task<GetListResponse<GetListTeamAndEmployeeListItemDto>> Handle(GetListByActiveTeamAndEmployeesRequest request, CancellationToken cancellationToken)
    {
        ...
        IPaginate<TeamAndEmployees> teamAndEmployeesList = await _teamAndEmployeeService.GetActiveList(request.PageRequest.Page, size: request.PageRequest.PageSize);
