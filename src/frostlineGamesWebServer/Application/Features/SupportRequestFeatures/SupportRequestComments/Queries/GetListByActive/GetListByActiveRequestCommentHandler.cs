...
public class GetListByActiveRequestCommentHandler : IRequestHandler<GetListByActiveRequestCommentRequest, GetListResponse<GetListSupportRequestCommentListModel>>
{
    ...
    public GetListByActiveRequestCommentHandler(ISupportRequestCommentService supportRequestCommentService, ISupportRequestService supportRequestService, SupportRequestCommentBusinessRules supportRequestCommentBusinessRules, IBardService bardService, IMapper mapper)
    {
    ...
    public async Task<GetListResponse<GetListSupportRequestCommentListModel>> Handle(GetListByActiveRequestCommentRequest request, CancellationToken cancellationToken)
    {
        ...
        IPaginate<SupportRequestComment> supportRequestCommentList = await _supportRequestCommentService.GetListByActive(request.PageRequest.Page, size: request.PageRequest.PageSize);
