...
public partial class FrostlineGamesDbContext : DbContext
{
    ...
    public virtual DbSet<Domain.Entities.SupportRequests.PossibleRequest> PossibleRequests { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.PossibleRequestAndTag> PossibleRequestAndTags { get; set; }
    ...
    public virtual DbSet<Domain.Entities.SupportRequests.SupportRequest> SupportRequests { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.SupportRequestAndSupportRequestCategory> SupportRequestAndSupportRequestCategories { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.SupportRequestAndTag> SupportRequestAndTags { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.SupportRequestCategory> SupportRequestCategories { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.SupportRequestComment> SupportRequestComments { get; set; }

    public virtual DbSet<Domain.Entities.SupportRequests.Tag> Tags { get; set; }
    ...
    public virtual DbSet<Domain.Entities.Files.File> Files { get; set; }
    public virtual DbSet<UserDetailImageFile> UserDetailImageFile { get; set; }
